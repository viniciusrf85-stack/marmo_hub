...
-- A tabela 'agenciadores' já existe, então não será recriada
--
-- ============================================
...
-- SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'olx_pedra' AND TABLE_NAME LIKE '%agenciador%' OR TABLE_NAME LIKE '%venda%' OR TABLE_NAME LIKE '%parcela%' OR TABLE_NAME LIKE '%comissao%' OR TABLE_NAME LIKE '%recebimento%' OR TABLE_NAME LIKE '%cliente%' OR TABLE_NAME LIKE '%importacao%' OR TABLE_NAME LIKE '%relatorio%';
